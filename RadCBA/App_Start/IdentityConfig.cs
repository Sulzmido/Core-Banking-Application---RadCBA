...
namespace RadCBA
{
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        public override async Task<ClaimsIdentity> CreateUserIdentityAsync(ApplicationUser user)
        {
            ...
            // on the fly/ on sign in claim binding
            // add dynamic user claims based on user's role..            
    ...
    public static class ExtendedClaimsProvider
    {
        public static IEnumerable<Claim> GetClaims(ApplicationUser user)
        {
            ...
            if (user.Role == null) roleClaims = new List<RoleClaim>();
            else roleClaims = user.Role.RoleClaims;
            foreach(var roleclaim in roleClaims)
            {
                claims.Add(CreateClaim("DynamicClaim", roleclaim.Name));
            }
            return claims;
        }
